...
import com.jxtzw.app.adapter.ListViewQuotationAdapter.ListItemView;
...
public class GridViewMenuAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null){
			convertView=mLayoutInflater.inflate(mResources.getLayout(R.layout.button_menu), null);
			listItemView = new ListItemView();
			listItemView.button=(Button) convertView.findViewById(R.id.menu_button);
